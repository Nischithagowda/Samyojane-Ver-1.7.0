...
public class New_Request_Kan extends AppCompatActivity{
    ...
    String eng_certi;
    TextView txt_raiseLoc, txt_appID, txt_appName, txt_BinCom, txt_appFatherName, txt_appMotherName, txt_ID_Num, txt_appMobileNum, txt_add1, txt_add2, txt_add3, txt_add_Pin, txt_ReportNo;
