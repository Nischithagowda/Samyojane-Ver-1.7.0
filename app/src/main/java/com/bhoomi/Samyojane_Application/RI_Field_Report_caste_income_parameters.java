...
public class RI_Field_Report_caste_income_parameters extends AppCompatActivity {
    ...
    TableRow TableApplicantCaste, TableCasteReservation, TableReasonForCreamyLayer, TableReasonForRejection, lRejection;
...
//        getCasteCode = Integer.parseInt(appCaste);
        ...
        getRejectionReason = sqlLiteOpenHelper_class1.Get_CertificateRejectionReason_BY_Code(Integer.parseInt(appRejectionReason), getString(R.string.reasons_tbl_reason_name));
